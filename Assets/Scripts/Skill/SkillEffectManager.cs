...
public class SkillEffectManager : MonoBehaviour
{
    ...
    // levelDelta는 그 보상의 Amount — 호출부가 넘긴다(SkillEffect.GetStatSummary 주석 참고).
    public string GetStatSummary(WaveRewardType type, int levelDelta)
    {
        return effects.TryGetValue(type, out var effect) ? effect.GetStatSummary(levelDelta) : string.Empty;
    }
