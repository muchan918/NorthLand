...
/// 3종 고정</b>이고(GDD §5.7), 「건물 건설」은 <i>"새 건물을 지어 할 수 있는 작업을 <b>해금</b>"</i>
/// (GDD §5.2)이라 <b>같은 건물을 여러 채 짓는 개념이 없다.</b> 해금으로 건물 <b>종류</b>가 늘어나는 것은
/// 이 전제를 깨지 않는다 — 새 종류는 새 SO라 키가 여전히 유일하다. 그래서 "SO 하나 = 씬 인스턴스 하나"가
