...
- **#3 자원 흐름 고정** (GDD §3.2): 나무/철/식량 = 주민 배치 생산 **또는 영토 확장 보상**, 마나석 = 영토 확장·전투 보상에서만.
  (개정: 기본 자원의 영토 확장 보상 경로 허용 — n0wst4ndup 결정. 교환 건물 등 다른 우회 경로는 여전히 WL-042 합의 대기.)
  → **생산 라인은 나무·철·식량 3종만** 구성(마나석 제외). 마나석은 후속 시스템이 지갑에 `Add`.
